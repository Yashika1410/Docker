...
* The original package name 'com.example.docker.microservice-b' is invalid and this project uses 'com.example.docker.microservice_b' instead.
...
* [JDBC API](https://docs.spring.io/spring-boot/docs/3.2.10-SNAPSHOT/reference/htmlsingle/index.html#data.sql)
